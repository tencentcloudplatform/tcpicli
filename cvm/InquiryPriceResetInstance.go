// 2017-12-18 15:38:40.568232 -0800 PST m=+530.007821152
...
func (c *CvmClient) InquiryPriceResetInstance(options ...string) (*InquiryPriceResetInstanceResp, error) {
	resp, err := c.DoAction("InquiryPriceResetInstance", options...)
	if err != nil {
		return nil, err
	}
...
func InquiryPriceResetInstance(options ...string) (*InquiryPriceResetInstanceResp, error) {
	return DefaultClient.InquiryPriceResetInstance(options...)
}
