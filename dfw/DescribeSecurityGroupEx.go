// 2018-01-08 13:57:35.210279 -0800 PST m=+1.560579070
...
func (c *DfwClient) DescribeSecurityGroupEx(options ...string) (*DescribeSecurityGroupExResp, error) {
	resp, err := c.DoAction("DescribeSecurityGroupEx", options...)
	if err != nil {
		return nil, err
	}
...
func DescribeSecurityGroupEx(options ...string) (*DescribeSecurityGroupExResp, error) {
	return DefaultClient.DescribeSecurityGroupEx(options...)
}
