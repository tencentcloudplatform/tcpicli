// 2017-12-12 20:49:27.683933473 +0000 UTC m=+85.679983264
...
func (c *CdnClient) GetCdnHostsDetailStatistics(options ...string) (*GetCdnHostsDetailStatisticsResp, error) {
	resp, err := c.DoAction("GetCdnHostsDetailStatistics", options...)
	if err != nil {
		return nil, err
	}
...
func GetCdnHostsDetailStatistics(options ...string) (*GetCdnHostsDetailStatisticsResp, error) {
	return DefaultClient.GetCdnHostsDetailStatistics(options...)
}
