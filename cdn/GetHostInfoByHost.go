// 2017-12-12 20:48:48.053371087 +0000 UTC m=+46.049420814
...
func (c *CdnClient) GetHostInfoByHost(hosts ...string) (*GetHostInfoByHostResp, error) {
	...
	resp, err := c.DoAction("GetHostInfoByHost", options...)
	if err != nil {
		return nil, err
	}
	var s GetHostInfoByHostResp
	err = json.Unmarshal(resp, &s)
	return &s, err
}

func GetHostInfoByHost(hosts ...string) (*GetHostInfoByHostResp, error) {
	return DefaultClient.GetHostInfoByHost(hosts...)
}
